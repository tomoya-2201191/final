    ...
    <div class="container">
        <div class="main">
            ...
            <?php
                ...
                $sql=$pdo->prepare('insert into car(name,star,rank,path,maker_id) values(?,?,?,?,?)');
                $sql->execute([$_POST['name'],$_POST['star'],$_POST['rank'],$_POST['path'],$_POST['maker']]);
                echo '<h2>登録できました</h2>';
                echo '<img src="../img/',$_POST['path'],'.jpg" width="650" height="400">';
                echo '<h1>',$_POST['name'],'</h1>';
                echo '<h3>乗りたい度 : ☆',$_POST['star'],'</h3>';
            ?>
        </div>
